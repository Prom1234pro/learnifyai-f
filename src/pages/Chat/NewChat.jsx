...
const NewChat = () => {
  ...
  return (
    <div className="flex h-screen sm:h-full flex-col justify-center items-center gap-5">
    ...
    <div className="sm:w-[90%] w-[100%] max-w-[680px] bottom-0 absolute sm:mt-2 sm:static mx-auto">
